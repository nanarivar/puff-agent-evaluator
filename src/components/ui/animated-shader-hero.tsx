...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-hero ${className}`}>
      <canvas
        ref={canvasRef}
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          {buttons && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-hero-fade-up animation-delay-800">
              {buttons.primary && (
                <button 
