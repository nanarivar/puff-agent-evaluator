...
const mrsPuffQuotes = [
  "I've taught for years. Your automation still scares me more.",
  "This workflow has more loops than my driving lessons.",
  "Agents are smart. This automation… not so much.",
  "I asked for logic. You gave me chaos with confidence.",
  "Even my worst student would've added error handling.",
  "Your agent tried its best. The automation did not.",
  "This workflow is technically working. Emotionally? It's not.",
  "I've seen jellyfish nets with better structure.",
  "Automation rule #1: just because it runs doesn't mean it's good.",
  "Your agent passed. Your automation stayed after class.",
  "This logic feels improvised. And not in a good jazz way.",
  "I'm calm. Your automation is not.",
  "Some automations learn. This one repeats mistakes.",
  "Even beginners check twice before pressing deploy.",
  "Your agent understood the task. The workflow panicked.",
  "This automation has trust issues. And I understand why.",
  "I don't yell anymore. I just lower scores.",
  "This workflow is one webhook away from disaster.",
  "Agents love clarity. This automation loves surprises.",
  "I graded this fairly. Don't argue with the rubric.",
  "This logic path feels… optimistic.",
  "Your automation believes everything will go right. It won't.",
  "I recommend fewer steps and fewer excuses.",
  "This workflow needs structure, not motivation.",
  "Your agent asked for order. You gave it vibes.",
  "This automation is brave. Reckless, but brave.",
  "I admire the confidence. Not the execution.",
  "Your workflow runs like a student who skipped class.",
  "Agents don't like guessing. Neither do I.",
  "This automation works… until it doesn't.",
  "Error handling is not optional. Trust me on this.",
  "I've seen better logic in a beginner's exam.",
  "This workflow needs supervision.",
  "Your agent tried to help. The automation ignored it.",
  "I don't fail automations. They fail themselves.",
  "This logic chain feels emotionally unstable.",
  "A good student would apologize. Your automation didn't.",
  "I recommend fewer triggers and more thinking.",
  "This automation believes in miracles.",
  "Agents appreciate clean inputs. This is not clean.",
  "I survived difficult students. I can survive this workflow.",
  "This automation needs a timeout and a reflection moment.",
  "I'm not mad. I'm disappointed in your logic.",
  "Your agent passed the exam. The automation skipped class.",
  "This workflow has potential. Currently unused.",
  "I expected structure. I received enthusiasm.",
  "Documentation matters. Remember that.",
  "This automation runs fast. In the wrong direction.",
  "Let's fix this before it hurts someone.",
];
